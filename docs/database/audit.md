...
documentada en [retención PostgreSQL](./retention.md). El particionamiento y la eliminación del
...
La política implementada queda documentada en [retención PostgreSQL](./retention.md):
...
`current_market_prices_item_loc_idx` están en [revisión de índices](./index-review.md). Una
